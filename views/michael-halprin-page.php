	...
	<p>
		<div class="row lead">
			<div class="col-md-8">
				...
				<p><strong>Phone:</strong> <a href="tel:+12153896913">215-389-6913</a></p>
				<p><strong>Toll Free:</strong> <a href="tel:+1866864257746">1-866-86-HALPRIN</a></p>
				<p><strong>Email:</strong> <a href="mailto:halprin@halprinlaw.com">halprin@halprinLaw.com</a></p>
			</div>
			<div class="col-md-4" align="center">
				<?php echo $this->html->image("/images/michael-halprin.jpg", array("alt" => "Michael J. Halprin", "style" => "margin:5px;", "align" => "center")); ?>
			</div>
		</div>
	</p>
